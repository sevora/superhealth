...
function Header() {
    return (
        <div>
            ...
            your inputs and results. The model results are not substitute for professional healthcare advice. Source code is on <a href="https://github.com/sevora/superhealth">Github</a>.
        </div>
    );
}
