        ...
        <div className="border rounded-md">
            ...
            <div className={`flex flex-col gap-3 px-3 overflow-hidden ${open ? 'block' : 'hidden'}}`}>
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input type="number" className="px-5 py-1 border rounded-full" value={store.restingBloodPressure} onChange={(event) => store.update({ restingBloodPressure: parseInt(event.currentTarget.value) || 1 })} />
                </div>
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input type="number" className="px-5 py-1 border rounded-full" value={store.maximumHeartRate} onChange={(event) => store.update({ maximumHeartRate: Math.max(parseInt(event.currentTarget.value) || 1, 1) })} />
                </div>
